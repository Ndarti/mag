                ...
                <?php if($student): ?>
                    <tr style="border: 1px solid black; padding: 5px; text-align: center;">
                        <td style="text-align: left;">
                           <d style="border: none" id="addi <?php echo e($student->id); ?>" class="op" data-student-id="<?php echo e($student->id); ?>">
                            <?php echo e($student->subject_name); ?></d>
                        </td>
                        <?php $__currentLoopData = $magsSortDate1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $magSort): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('welcom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liza/Рабочий стол/Дипломное проектирование/Program/ElectronicMagazine/resources/views/student.blade.php ENDPATH**/ ?>