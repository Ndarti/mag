<?php use App\Models\EntranceModl;use App\Models\Mag; ?>
...
<?php $__env->startSection('main_content'); ?>
    <?php if($uniqueStudentIDs): ?>
    <?php if(count($uniqueStudentIDs) > 0): ?>
        <table id="q">
            <thead>
            <tr style="border: 1px solid black; padding: 5px; text-align: center;">
                <th style="text-align: left;">ФИО|дата</th>
                <?php $__currentLoopData = $magsSortDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $magSort): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <th style="border: 1px solid black; padding: 5px; text-align: center;"><?php echo e(date('d.m', strtotime($magSort->date))); ?></th>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <th style="text-align: center;">ср-зн</th>
            </tr>
            </thead>
            <tbody>
            <?php $__currentLoopData = $uniqueStudentIDs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <?php if($student): ?>
                    <tr style="border: 1px solid black; padding: 5px; text-align: center;">
                        <td style="text-align: left;">
                            <button class="add-student-button" data-student-id="<?php echo e($student->id); ?>">+</button>
                            ...
                            <td style="border: 1px solid black; padding: 5px; text-align: center;">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!$isFirstMark): ?>
                                            &nbsp;  <?php endif; ?>
                                        <?php if($result->mark < 4 && $result->tip_mark!="лекция" && $result->tip_mark!="зачёт"): ?>
                                            <button class='red-mark' style='cursor: pointer;' data-result-id='<?php echo e($result->id); ?>'><?php echo e($result->mark); ?></button>
                                            <?php elseif($result->tip_mark=="зачёт"): ?>
                                            зч
                                        <?php else: ?>
                                                <button class='red-mark' style='color:black; cursor: pointer;' data-result-id='<?php echo e($result->id); ?>'><?php echo e($result->mark); ?></button>
                        ...
                        <td style="text-align: center;"><?php $A= number_format($collection->Pop(), 2);  ?>
    <span style="color: <?php echo e($A < 3 ? 'red' : ''); ?>">
        <?php echo e($A); ?>

    </span></td> </tr>
                <?php else: ?>
                    <tr>
                        <td colspan="<?php echo e(count($magsSortDate) + 2); ?>" style="text-align: center;">Студент с ID: <?php echo e($studentId); ?> не найден</td>
                    </tr>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
    ...
    <form method="post" action="/controller/action/{data1}/{data2}">
        ...
        <div id="editMarkPopup" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1000;">
            <div class="popup-content">
                ...
                <input type="hidden" name="magsSortDate" value="<?php echo e($magsSortDate); ?>">
                <input type="hidden" name="groupSelect" value="<?php echo e($Group); ?>">
                <input type="hidden" name="subject" value="<?php echo e($Subject); ?>">
                <input type="hidden" name="markCount" value="<?php echo e($markCount); ?>">
                <input type="hidden" name="studentId" value="<?php echo e($studentId); ?>">
                <input type="hidden" name="result" value="<?php echo e($result); ?>">
...
<?php echo csrf_field(); ?>
    ...
    <?php if($uniqueStudentIDs1): ?>
        <?php if(count($uniqueStudentIDs1) > 0): ?>
            <table id="myTable">
                <thead>
                <tr style="border: 1px solid black; padding: 5px; text-align: center;">
                    <th style="text-align: left;">ФИО|дата</th>
                    <?php $__currentLoopData = $magsSortDate1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $magSort): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <th style="border: 1px solid black; padding: 5px; text-align: center;"><?php echo e(date('d.m', strtotime($magSort->date))); ?></th>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <tbody>
                <?php $__currentLoopData = $uniqueStudentIDs1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $student = EntranceModl::find($studentId);
                        $average = 0; // Initialize average variable outside the loop
                        $markCount = 0; // Initialize mark count variable outside the loop
                    ...
                    <?php if($student): ?>
                        <tr style="border: 1px solid black; padding: 5px; text-align: center;">
                            <td style="text-align: left;">
                                <button style="border: none" id="addi <?php echo e($student->id); ?>" class="op" data-student-id="<?php echo e($student->id); ?>"  >+</button>
                                <?php echo e($student->fio); ?>
                                ...
                                <td style="border: 1px solid black; padding: 5px; text-align: center;">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(!$isFirstMark): ?>
                                                &nbsp;  <?php endif; ?>
                                                <?php if($result->propysc == "да" && $result->hours > 0): ?>
                                                    <button style="color: #eb3aff; background: white; border: none;"
                                                            data-student-id="<?php echo e($student->id); ?>"
                                                            id="popupButton_<?php echo e($student->id); ?>_<?php echo e($magSort->date); ?>"
                                                            data-hours="<?php echo e($result->hours); ?>"
                                                            onclick="openPopup(this, <?php echo e($student->id); ?>, '<?php echo e($result->date); ?>')">Н
                                                    </button>
                                                <?php else: ?>
                                                    Н
                                            <?php endif; ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <td style="text-align: center;"><?php echo e($collection1->Pop()); ?></td> </tr>
                    <?php else: ?>
                        <tr>
                            <td colspan="<?php echo e(count($magsSortDate) + 2); ?>" style="text-align: center;">Студент с ID: <?php echo e($studentId); ?> не найден</td>
                        </tr>
            ...
            <div id="miniForm" style="text-align: center;">
                <div class="win">
                    ...
                    <form id="form" method="post" action="/new_prop"><?php echo csrf_field(); ?>
                        ...
                        <input type="hidden" name="groupSelect" value="<?php echo e($Group); ?>">
                        <input type="hidden" name="subject" value="<?php echo e($Subject); ?>">
                        <input type="hidden" name="monthSelect" value=<?php echo e($month); ?>>
            ...
            <script>
                ...
                addStudentButtons.forEach(button => {
                    button.addEventListener('click', (event) => {
                        ...
                        window.Group = <?php echo json_encode($Group, 15, 512) ?>;
                        const group=<?php echo json_encode($Group, 15, 512) ?>;
            ...
            <script> var id = window.localStorage.getItem('id');
                ...
                addStudentButtons.forEach(button => {
                    button.addEventListener('click', (event) => {
                        ...
                        studentIdSpan.textContent = studentId;
                        window.Group = <?php echo json_encode($Group, 15, 512) ?>;
                        const a=<?php echo json_encode($Group, 15, 512) ?>;
                        document.getElementById('hidden1').value =sSubject;
                        document.getElementById('hidden2').value=studentId;
...
<?php echo $__env->make('welcom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liza/Рабочий стол/Дипломное проектирование/Program/ElectronicMagazine/resources/views/mag.blade.php ENDPATH**/ ?>