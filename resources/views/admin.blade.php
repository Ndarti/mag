...
@section('main_content')
    ...
    <div id="userForm">
        <form method="post" action="/admin" enctype="multipart/form-data">@csrf  <label for="userType">Тип пользователя:</label>
...
<div id="userForm">
    <form method="post" action="/user">@csrf
...
<br>
    ...
    <div id="subjectForm" style="display: none;">
        ...
        <form method="post" action="/addSubject">@csrf
